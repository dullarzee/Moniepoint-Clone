import RollyItem from "./rollyItem";

export default function Rolly() {
    return (
        <>
            <div className="flex h-[7rem] lg:h-[13rem] gap-x-[2%] animate-slideShow">
                <RollyItem>
                    <img
                        alt="justrite logo"
                        className="h-full mx-auto rounded-lg"
                        src="/images/justriteLogo.jpg"
                    ></img>
                </RollyItem>
                <RollyItem>
                    <img
                ...
                <RollyItem>
                    <img
                        alt="spar logo"
                        className="mx-auto h-[50%] "
                        src="/images/spar-seeklogo.png"
                    ></img>
                </RollyItem>
                <RollyItem>
                    <img
                        alt="panarottis logo"
                        className="mx-auto h-[50%] scale-[1.5]"
                        src="/images/thePlaceLogo.png"
                    ></img>
                </RollyItem>
                <RollyItem>
                    <img
                        ...
                        className="mx-auto h-[50%] scale-[1.5]"
                        src="/images/dominoesLogo.png"
                    ></img>
                </RollyItem>
                <RollyItem>
                    <img
                        alt="rimberio fast food logo"
                        className="mx-auto h-[50%] scale-[1.5] rounded-lg"
                        src="/images/rimberioFastFoodLogo.jpg"
                    ></img>
                </RollyItem>
                <RollyItem>
                    <img
                        alt="panarottis logo"
                        className="mx-auto h-[50%] "
                        src="/images/renneRouleauLogo.png"
                    ></img>
                </RollyItem>
                {/*clone division */}
                <RollyItem>
